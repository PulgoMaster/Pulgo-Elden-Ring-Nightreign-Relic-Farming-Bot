...
# Skill name → weapon types it appears on (for dormant power recommendation)
# Only populated for skills that strongly imply a specific weapon category
_SKILL_WEAPON_TYPES: dict[str, list[str]] = {
    "Rain of Arrows":   ["Greatbow"],
    "Barrage":          ["Bow"],
    "Mighty Shot":      ["Bow"],
    "Through and Through": ["Bow"],
    "Enchanted Shot":   ["Bow"],
    "Sky Shot":         ["Bow"],
    "Radahn's Rain":    ["Greatbow"],
    "Unsheathe":        ["Katana"],
    "Transient Moonlight": ["Katana"],
    "Waterfowl Dance":  ["Curved Sword"],
    "Corpse Piler":     ["Katana"],
    "Bloodhound's Finesse": ["Curved Sword"],
    "Storm Ruler":      ["Colossal Sword"],
    "Moonlight Greatsword": ["Greatsword"],
    "Spinning Wheel":   ["Greataxe"],
    "Spearcall Ritual": ["Great Spear"],
    "Siluria's Woe":    ["Great Spear"],
    "Giant Hunt":       ["Great Hammer", "Colossal Weapon"],
    "Hoarfrost Stomp":  ["Katana"],
}
...
_WEAPON_KEYWORDS: dict[str, list[str]] = {
    ...
    "Colossal Sword":       ["colossal sword", "zweihander", "grafted blade", "starscourge"],
    "Curved Sword":         ["curved sword", "scimitar", "falchion", "bloodhound's fang"],
    "Curved Greatsword":    ["curved greatsword", "beastman's cleaver"],
    ...
    "Spear":                ["spear", "short spear", "lance", "partisan"],
    "Great Spear":          ["great spear", "siluria", "treespear"],
